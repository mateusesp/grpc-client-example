...
public final class userGrpc {
  ...
  public static io.grpc.MethodDescriptor<Empty,
      APIResponse> getLogoutMethod() {
    io.grpc.MethodDescriptor<Empty, APIResponse> getLogoutMethod;
    if ((getLogoutMethod = userGrpc.getLogoutMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getLogoutMethod = userGrpc.getLogoutMethod) == null) {
          userGrpc.getLogoutMethod = getLogoutMethod = 
              io.grpc.MethodDescriptor.<Empty, APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "proto.user", "logout"))
              .setSampledToLocalTracing(true)
  ...
  public static final class userBlockingStub extends io.grpc.stub.AbstractStub<userBlockingStub> {
    ...
    /**
     */
    public APIResponse logout(Empty request) {
      return blockingUnaryCall(
  ...
  public static final class userFutureStub extends io.grpc.stub.AbstractStub<userFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<APIResponse> logout(
        Empty request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_LOGOUT:
          serviceImpl.logout((Empty) request,
              (io.grpc.stub.StreamObserver<APIResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class userBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return UserProtos.getDescriptor();
    }
